...
void main() {
  ...
  group('description', () {
    ...
    test('is null rather than empty when the page has no text', () {
      ...
      // Genuinely empty: which mod this is does not come through here at all —
      // the install writes it into the origin block, and the link every surface
      // shows is derived from that. So a page with nothing on it contributes
      // nothing, and no sidecar is written for it.
